...
const KreiranjeCenovnika = () => {
	...
	function kreirajCenovnik(e) {
		...
		axios.post('http://localhost:8080/api/cenovnici', cenovnik).then(() => console.log("Kreiran"));
	}
		...
		<div className="container mx-auto flex justify-center p-5">
			<form className="w-6/12 rounded overflow-hidden shadow-lg flex justify-center flex-col p-5">
				...
				<div className="flex flex-row justify-center">
					...
					<a className="bg-green-500 mx-2 py-1 px-2 font-medium text-white rounded-md h-10" onClick={() => setShowModal(true)}>Dodaj stavku</a>
				</div>
				...
				<button className="bg-green-500 mx-2 py-1 my-3 px-2 font-medium text-white rounded-md h-10" disabled={!canCreate} onClick={(e) => kreirajCenovnik(e)}>Kreiraj cenovnik</button>
			</form>
